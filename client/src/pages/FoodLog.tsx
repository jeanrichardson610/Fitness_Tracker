  ...
  return (
    <div className="page-container">
      ...
      <div className="page-content-grid">
          ...
          <div className="space-y-4">
            ...
            {loading && (
              <div className="fixed inset-0 bg-slate-100/50 dark:bg-slate-900/50 backdrop-blur flex items-center justify-center z-100">
                <Loader2Icon className="w-8 h-8 text-emerald-600 dark:text-emerald-400 animate-spin" />
              </div>
            )}
          </div>
        )}
        ...
        {/* Food Entries List */}
        {entries.length === 0 ? (
          <Card className="txt-center py-12">
                ...
                <Card key={mealType}>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-xl bg-emerald-500/20 flex items-center justify-center ${mealColors[mealTypeKey]}`}
                      >
                  ...
                  <div className="space-y-2">
                    {groupedEntries[mealTypeKey].map((entry) => (
                      ...
                      >
                        <div className="flex-">
                          <p className="font-mediu, text-slate-700 dark:text-slate-200">
                            {entry.name}
                          </p>
